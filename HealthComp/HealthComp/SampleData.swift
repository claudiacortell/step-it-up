...
var sample_friends: [User] = [
    ...
    User(id: UUID(), name: "Phillip Le", username: "pl123", pfp: "https://pbs.twimg.com/profile_images/1458771374311460866/aTRX-B1Q_400x400.jpg", friends: [UUID](), groups: [UUID](), data: HealthData(dailyStep: 11000, dailyMileage: 5, dailyFlights: 2, weeklyStep: 20000, weeklyMileage: 3)),
...
let currentUser = User(id: UUID(), name: "Roaree the Lion", username: "roaree69", pfp: "https://gocolumbialions.com/images/2019/10/11/20170916ColumbiaFootball_0700.JPG", friends: [UUID](), groups: [UUID](), data: HealthData(dailyStep: 11000, dailyMileage: 5, dailyFlights: 2, weeklyStep: 20000, weeklyMileage: 3))
